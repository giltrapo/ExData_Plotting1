...
### create a matrix of 2 rows x 2 columns plots
par(mfrow=c(2,2))
### Create plot4 on png device
with(housepwc, plot(datetime, Global_active_power, type = "l", 
                    ylab = "Global Active Power", xlab = ""))
with(housepwc, plot(datetime, Voltage, type = "l"))
...
legend("topright", lty=1, col = c("black", "blue", "red"), 
       ...
       bty = "n")
with(housepwc, plot(datetime, Global_reactive_power, type = "l"))
### Close the png file device
dev.off()
### create a matrix of 1 row x 1 column plots
par(mfrow=c(1,1))